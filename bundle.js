...
/***/ function(module, exports, __webpack_require__) {
	...
	var ajaxAuth = __webpack_require__(3);
	var ajaxDrinks = __webpack_require__(5);
	var get = __webpack_require__(6);
	var ajaxComments = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Create drink
	var createDrink = function createDrink(e) {
	  var $store_id = $("input[name='drinks[store_id]']").val();
	  var formData = new FormData(e.target);
	  e.preventDefault();
	...
	var getDrinkId = function getDrinkId(e) {
	  drinkId = $(e.target).attr('data-id');
	};

	var updateDrink = function updateDrink(e) {
	  e.preventDefault();
	  $.ajax({
	...
	var deleteDrink = function deleteDrink(e) {
	  e.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  getDrinks: getDrinks,
	  getKftDrinks: getKftDrinks,
	  getChatimeDrinks: getChatimeDrinks,
	  getTeadoDrinks: getTeadoDrinks
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"drinks\" data-id= "
	    ...
	    + "<br/> Toppings: "
	    + alias4(((helper = (helper = helpers.toppings || (depth0 != null ? depth0.toppings : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"toppings","hash":{},"data":data}) : helper)))
	    + "<br/> Notes: "
	    + alias4(((helper = (helper = helpers.notes || (depth0 != null ? depth0.notes : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"notes","hash":{},"data":data}) : helper)))
	    + "</br>\n\n      <div class=\"update-and-delete buttons\">\n        <button class=\"btn btn-primary btn-md update-drink\" data-toggle=\"modal\" data-target=\"#updateDrinkModal\" data-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Update</button>\n        <button type=\"button\" class=\"btn btn-primary btn-md delete-drink\" data-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " id=\"delete-drink\">Delete</button>\n      </div>\n\n    <p>\n      <a data-toggle=\"collapse\" href=\"#commentsCollapse"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" aria-expanded=\"false\" aria-controls=\"collapseExample\" id=\"comments-link\">\n        <span class=\"pull-right\">Comments</span><br/>\n      </a>\n    </p>\n    <div class=\"collapse\" id=\"commentsCollapse"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n\n      <button class=\"btn btn-primary btn-md create-comment\" data-toggle=\"modal\" data-target=\"#createCommentModal\" data-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Add Comment</button>\n      <!-- "
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = ((stack1 = (depth0 != null ? depth0.bubbleTea : depth0)) != null ? stack1.bbtApp : stack1)) != null ? stack1.user : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + " -->\n\n"
	  ...
	  return "\n\n          <textarea rows=\"3\" class=\"comment-form\" name=\"comments[comment]\" id=\"comment-textarea\"></textarea>\n          <button type=\"submit\" class=\"btn btn-primary comment-submit\" data-id="
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.drinks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Create drink
	var createComment = function createComment(callback) {
	  // e.preventDefault();
	  callback;
