...
/***/ function(module, exports, __webpack_require__) {
	...
	var createDrink = function createDrink(e) {
	  ...
	  var url = bubbleTea.bbtApp.baseUrl + '/stores/' + $store_id + '/drinks';
	  console.log(url);
	  e.preventDefault();
	  var formData = new FormData(e.target);
	  $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"drinks\" data-id="
	    ...
	    + "</br>\n\n    <div class=\"update-and-delete buttons\"><button class=\"btn btn-primary btn-md update-drink\" data-toggle=\"modal\" data-target=\"#updateDrinkModal\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Update</button>\n    <button type=\"button\" class=\"btn btn-primary btn-md delete-drink\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " id=\"delete-drink\">Delete</button></div>\n  </div><p>\n";
